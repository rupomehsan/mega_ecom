            ...
            <div class="single-product-info ps-3">
                <div class="single-product-info-top">
                    ...
                    <div class="single-product-price display-flex-center mb-24">
                        <div v-if="product.current_price" class="product-price-widget m-0 p-0 offer-price">
                            <span class="offer-price-title">Current Price : </span>
                            <span class="offer-main-price">
                                {{ product.current_price }} BDT
                            </span>
                        </div>
                        <template v-if="is_discount && product.discount_amount > 0">
                            <div v-if="product.customer_sales_price" class="product-price-widget m-0 p-0 regular-price">
